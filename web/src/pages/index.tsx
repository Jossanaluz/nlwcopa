  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28'>
      <main>
        ...
        <div className='mt-10 pt-10 border-t border-gray-600 divide-x divide-gray-600 flex text-gray-100'>
      ...
      <Image src={appPreviewImg} alt="Dois celulares exibindo uma prévia da apicação móvel do NLW Copa" quality={100} />
    </div>
  )
}
...
export const getServerSideProps = async () => {
  ...
  // Realizar as duas chamadas para a api em pararelo para que uma não fique esperando a outra para começar a executar
